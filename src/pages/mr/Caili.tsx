...
const Mrua = () => {
  ...
  const [yIni, setYIni] = useState<number>(30);
      ...
      <Layout>
        ...
        >
          ...
          >
            <div style={{ flex: "0 0 auto", width: "600px" }}>
              <Card style={{ height: 400 }}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Introduce los valores iniciales para el cálculo de la caída
                    libre.
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <div
              style={{ flex: "0 0 auto", width: "1000px", height: 400 }}
            ...
            <Button
              onClick={() => {
                ...
                exportToExcel({
                  ...
                  fileName: `datos-caida-libre-${timestamp}`,
                  sheetName: "Resultados Caída Libre",
                });
              }}
              variant="outline"
